...
public class GdsRelationshipRecord extends GdsRecord {
    ...
    public static final String SOURCE_FIELD = Neo4jDefaults.SOURCE_FIELD;
    public static final String TARGET_FIELD = Neo4jDefaults.TARGET_FIELD;
    public static final String TYPE_FIELD = Neo4jDefaults.TYPE_FIELD;
